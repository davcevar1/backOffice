      ...
      function ($scope, $http, $q, $timeout, $location, $sce, $interval) {
        ...
        $scope.customerFilters = {
          field: [{
            ...
            {
              label: "Número Cliente CORE",
              id: 2
            }
          ]
        };
        $scope.accountFilters = {
          field: [{
            label: "CURP",
            id: 1
          },
        ...
        $scope.accounts = {
          ...
          change: function () {
            location.href = 'detalle-deposito.html';
          },
          scrollable: false,
          selectable: true,
          columns: [{
        ...
        $scope.header = {
          primaryText: 'Juan Martinez',
          secondaryText: '#DEPPL.1.08.003688',
          hideMoreInfo: true,
          fields: [{
              label: 'Producto',
              value: 'Plazo fijo',
        ...
        $scope.owners = {
          ...
          columns: [{
            ...
            },
            {
              ...
              template: '<button class="btn btn-default btn-sm" title="Editar" ng-click="showModal(\'owner\', \'#: data.type #\');"><span class="fa fa-pencil fa-fw"></span></button><button class="btn btn-default btn-sm" title="Eliminar"><span class="fa fa-times fa-fw"></span></button>'
            }
          ],
          toolbar: '<button class="btn btn-default k-grid-add" ng-click="showModal(\'owner\');"><span class="fa fa-plus"></span> Agregar</button>'
        };
        $scope.owners2 = {
          dataSource: {
            transport: {
              read: {
                url: "../../mocks/owners2.json",
                contentType: "application/json; charset=utf-8",
                dataType: "json"
              }
            }
          ...
          columns: [{
            ...
            },
            {
              ...
              template: '<button class="btn btn-default btn-sm" title="Ver detalle" ng-click="showModal(\'owner\');"><span class="fa fa-eye fa-fw"></span></button>'
            }
          ]
        };
        $scope.beneficiaries = {
          ...
          columns: [{
            ...
            },
            {
              ...
              template: '<button class="btn btn-default btn-sm" title="Editar" ng-click="showModal(\'beneficiary\');"><span class="fa fa-pencil fa-fw"></span></button><button class="btn btn-default btn-sm" title="Eliminar"><span class="fa fa-times fa-fw"></span></button>'
            }
          ],
          toolbar: '<button class="btn btn-default k-grid-add" ng-click="showModal(\'beneficiary\');"><span class="fa fa-plus"></span> Agregar</button>'
        };
        $scope.beneficiaries2 = {
          dataSource: {
            transport: {
              read: {
                url: "../../mocks/owners.json",
          ...
          columns: [{
            ...
            },
            {
              ...
              template: '<button class="btn btn-default btn-sm" title="Editar" ng-click="showModal(\'beneficiary\');"><span class="fa fa-eye fa-fw"></span></button>'
            }
          ]
        };
        $scope.representatives2 = {
          dataSource: {
            transport: {
              read: {
                url: "../../mocks/owners.json",
          ...
          columns: [{
            ...
            },
            {
              ...
              template: '<button class="btn btn-default btn-sm" title="Editar" ng-click="showModal(\'representative\');"><span class="fa fa-pencil fa-fw"></span></button><button class="btn btn-default btn-sm" title="Eliminar"><span class="fa fa-times fa-fw"></span></button>'
            }
          ],
          toolbar: '<button class="btn btn-default k-grid-add" ng-click="showModal(\'representative\');"><span class="fa fa-plus"></span> Agregar</button>'
        };
        $scope.shareholders = {
          dataSource: {
            transport: {
          ...
          columns: [{
            ...
            },
            {
              ...
              template: '<button class="btn btn-default btn-sm" title="Editar" ng-click="showModal(\'shareholders-popup\');"><span class="fa fa-pencil fa-fw"></span></button><button class="btn btn-default btn-sm" title="Eliminar"><span class="fa fa-times fa-fw"></span></button>'
            }
          ],
          toolbar: '<button class="btn btn-default k-grid-add" ng-click="showModal(\'shareholders-popup\');"><span class="fa fa-plus"></span> Agregar</button>'
        };
        $scope.in = {
          dataSource: {
            transport: {
          ...
          columns: [{
            ...
            },
            {
              ...
              template: '<button class="btn btn-default btn-sm" title="Editar" ng-click="showModal(\'in-popup\');"><span class="fa fa-pencil fa-fw"></span></button><button class="btn btn-default btn-sm" title="Eliminar"><span class="fa fa-times fa-fw"></span></button>'
            }
          ],
          toolbar: '<button class="btn btn-default k-grid-add" ng-click="showModal(\'in-popup\');"><span class="fa fa-plus"></span> Agregar</button>'
        };
        $scope.out = {
          dataSource: {
            transport: {
          ...
          columns: [{
            ...
            },
            {
              ...
              template: '<button class="btn btn-default btn-sm" title="Editar" ng-click="showModal(\'out-popup\');"><span class="fa fa-pencil fa-fw"></span></button><button class="btn btn-default btn-sm" title="Eliminar"><span class="fa fa-times fa-fw"></span></button>'
            }
          ],
          toolbar: '<button class="btn btn-default k-grid-add" ng-click="showModal(\'out-popup\');"><span class="fa fa-plus"></span> Agregar</button>'
        };
        $scope.setCustomersResults = function (value) {
          $scope.customerSelectedField.hasResults = value;
        }
        $scope.customers = {
          dataSource: {
            transport: {
              read: {
                url: "../../mocks/clientes2.json",
                contentType: "application/json; charset=utf-8",
                dataType: "json"
              }
            }
          ...
          change: function () {
            location.href = 'detalle-cuenta.html';
          },
          selectable: true,
          scrollable: false,
          columns: [{
        ...
        $scope.customerSelectedField = $scope.customerFilters.field[0];
        $scope.accountSelectedField = $scope.accountFilters.field[0];
        $scope.setField = function (field) {
          $scope.selectedField = field;
        }
        $scope.setCustomerField = function (field) {
          $scope.customerSelectedField = field;
        }
        $scope.setAccountField = function (field) {
          $scope.accountSelectedField = field;
        }
        $scope.showModal = function (selector, value) {
          console.log(value);
          $('#' + selector).modal();
        }
